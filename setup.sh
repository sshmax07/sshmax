...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rendiap/sshmax/main/"
...
wget -q https://raw.githubusercontent.com/rendiap/sshmax/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
