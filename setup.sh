...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sshmax07/sshmax/main/"
...
wget -q https://raw.githubusercontent.com/sshmax07/sshmax/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
